...
loadData () {
	...
	then
  		...
  		echo "WARNING: You need pip to run this script.\nOtherwise make sure to have the pymongo lib inside your python environment."
	fi
	python3 ./import_data/import_average.py
	echo -e "\033[1;32mdone\033[0m"
}
